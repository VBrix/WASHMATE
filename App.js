  ...
  const TabNavigation = () => {
    return (
      <SafeAreaProvider>
        <NavigationContainer>
          <Tab.Navigator>
            <Tab.Screen name={'Home'} component={StackNavigation} options={{headerShown: null}} />
            <Tab.Screen name={"Dashboard"} component={DashboardScreen} options={{headerTitle: "", headerTransparent: true}} />
          </Tab.Navigator>
        </NavigationContainer>
      </SafeAreaProvider>
    );
